...
export default function VenueSection() {
  ...
  return (
    <section ref={containerRef} className="py-20 px-6 max-w-lg mx-auto flex flex-col items-center gap-10 text-center">
      ...
      <div className="venue-reveal flex flex-col gap-6 sans text-sm opacity-80 leading-loose w-full text-center">
        <div className="flex flex-col gap-1">
          <p className="font-semibold text-accent tracking-widest text-xs uppercase mb-1">Day 1 • Nikah</p>
          <p className="text-base"><strong>Liya Auditorium</strong></p>
          <p className="text-sm">Changaleeri, Mannarkkad</p>
        </div>
        
        <div className="w-12 h-[1px] bg-accent/20 mx-auto" />
        
        <div className="flex flex-col gap-1">
          <p className="font-semibold text-accent tracking-widest text-xs uppercase mb-1">Day 2 • Reception (Apr 19, 11am)</p>
          <p className="text-base"><strong>Karimbalayil Convention Centre</strong></p>
          <p className="text-sm">Karuvampadi, Vazhampuram</p>
        </div>
      </div>

      <div className="venue-reveal w-full mt-4">
